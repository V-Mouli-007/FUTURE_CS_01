# Read-Only Vulnerability Assessment (Internal Scope)
...
* **Type of Testing:** Passive reconnaissance, header analysis, and banner grabbing.
* **Out of Scope:** Active exploitation, brute forcing, DoS, automated intrusive scanning, and external/public network testing.

## Tools Utilized
* **Nmap:** Used for local network service enumeration and version detection.
* **OWASP ZAP:** Utilized as an intercepting proxy for passive vulnerability detection on the local web application.
